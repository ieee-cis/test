...
% Compilar com make4ht -c config.cfg index.tex
% tem que primeiro usar o pdflatex e bibtex para criar as referencias
...
\begin{equation}
\mathcal{T} = \frac{1}{min(n',t)} \sum_{i=max(t-n'+1,1)}^{t}  \| \hat{y}_i - y_i \|; 
\end{equation}
